...
import home_mainBg from "../../assets/img/home_mainBg.jpg";
      ...
      <div className="landing_page" style={landing_page_style}>
        <div className="container">
          <div className="landing_page_text">
            <h1>
              the <span>Maeve Sofabed</span>,
            </h1>
            <h1>now in performance velvet</h1>
            <LinkButton path="/products/5" label="Shop Maeve Sofabed" />
          </div>
        </div>
      </div>
